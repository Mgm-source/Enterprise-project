 ...
 */
@WebServlet("/Insert")
public class InsertServlet extends HttpServlet implements ParameterCheck {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(setParamters.get("error")) {
			...
			// when there is no errors or (additional parameters that arent recognised) the servlet inserts a film
			if(setParamters.get("error").equals(false))
			{
				...
				filmDB.insertFilm(filmDB.createFilm(title, year, director, stars, review));
